        ...
        <div className="glass-panel-heavy border border-white/10 p-8 rounded-[2rem] shadow-2xl">
          ...
          <form className="space-y-4">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex justify-between items-center">
                ...
                <Link href="#" className="text-xs text-primary/60 hover:text-primary transition-colors">
                  Forgot?
                </Link>
              </div>
          ...
          <div className="mt-6 pt-5 border-t border-white/5 text-center leading-relaxed">
            <p className="text-sm text-text-vault/40">
              New to Clivv?{" "}
              <Link href="/register" className="text-primary hover:underline underline-offset-4 font-semibold">
                Create an account
              </Link>
            </p>
          </div>
